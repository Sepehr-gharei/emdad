...
class Advanced_Editor_Tools {
	...
	public function enqueue_scripts( $page ) {
		if ( 'settings_page_tinymce-advanced' === $page ) {
			$plugin_url = wp_directory_uri . "/includes/tinymce-advanced/plugin-assets/";
	...
	public function mce_external_plugins( $mce_plugins ) {
		...
		$plugin_url = wp_directory_uri . "/includes/tinymce-advanced/mce/";
	...
	public function settings_page() {
		...
		include_once( wp_directory . '/includes/tinymce-advanced/tadv_admin.php' );
	}
